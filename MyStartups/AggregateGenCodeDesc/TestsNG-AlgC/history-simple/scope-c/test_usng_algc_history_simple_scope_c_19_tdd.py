...
FIXTURE_GIT_DIR = Path(__file__).resolve().parents[3] / "TestdataNG-AlgC" / "history-simple" / "scope-c" / "19" / "git" / "default"


class TestUsngAlgcHistorySimpleScopeC19Tdd(unittest.TestCase):
    maxDiff = None
