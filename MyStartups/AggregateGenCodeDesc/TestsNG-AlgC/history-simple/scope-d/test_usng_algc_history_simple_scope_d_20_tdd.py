...
FIXTURE_GIT_DIR = Path(__file__).resolve().parents[3] / "TestdataNG-AlgC" / "history-simple" / "scope-d" / "20" / "git" / "default"


class TestUsngAlgcHistorySimpleScopeD20Tdd(unittest.TestCase):
    maxDiff = None
