...
FIXTURE_GIT_DIR = Path(__file__).resolve().parents[3] / "TestdataNG-AlgC" / "history-simple" / "scope-a" / "01" / "git" / "default"
FIXTURE_SVN_DIR = Path(__file__).resolve().parents[3] / "TestdataNG-AlgC" / "history-simple" / "scope-a" / "01" / "svn" / "default"


class TestUsngAlgcHistorySimpleScopeA01Tdd(unittest.TestCase):
    maxDiff = None
