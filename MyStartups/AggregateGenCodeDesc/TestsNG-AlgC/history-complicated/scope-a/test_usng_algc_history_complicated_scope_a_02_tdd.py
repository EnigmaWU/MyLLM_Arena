...
FIXTURE_GIT_DIR = Path(__file__).resolve().parents[3] / "TestdataNG-AlgC" / "history-complicated" / "scope-a" / "02" / "git" / "default"
FIXTURE_SVN_DIR = Path(__file__).resolve().parents[3] / "TestdataNG-AlgC" / "history-complicated" / "scope-a" / "02" / "svn" / "default"


class TestUsngAlgcHistoryComplicatedScopeA02Tdd(unittest.TestCase):
    maxDiff = None
    ...
    def test_cli_matches_git_expected_result_when_human_rewrite_resets_ai_attribution(self) -> None:
    ...
    def test_cli_matches_svn_expected_result_when_human_rewrite_resets_ai_attribution(self) -> None:
