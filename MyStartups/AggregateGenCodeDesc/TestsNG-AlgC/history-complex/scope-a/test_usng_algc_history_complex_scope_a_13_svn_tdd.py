...
class TestUsngAlgcHistoryComplexScopeA13SvnTdd(unittest.TestCase):
    ...
    def _build_protocol(self, query: dict) -> dict:
        ...
        for feature_index in range(FEATURE_BRANCH_COUNT):
            file_name = f"trunk/src/feature_{feature_index:03d}.py"
                    ...
                    "codeLines": [
                        {
                            ...
                            "genMethod": "Manual",
                            "blame": {
                                "revisionId": f"r{1000 + feature_index}",
                        ...
                        },
                        {
                            ...
                            "blame": {
                                "revisionId": f"r{11000 + feature_index * 2}",
                                "originalFilePath": file_name,
                                "originalLine": 2,
                        ...
                        },
                        {
                            ...
                            "genMethod": "codeCompletion" if ratio > 0 else "Manual",
                            "blame": {
                                "revisionId": f"r{11001 + feature_index * 2}",
                                "originalFilePath": file_name,
                                "originalLine": 3,
        ...
        return {
            ...
            "codeAgent": "ProductionScaleSvnAgent",
            "SUMMARY": {
                "totalCodeLines": 200,
