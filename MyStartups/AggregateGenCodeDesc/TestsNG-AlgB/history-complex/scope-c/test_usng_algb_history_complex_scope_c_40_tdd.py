...
FIXTURE_GIT_DIR = Path(__file__).resolve().parents[3] / "TestdataNG-AlgB" / "history-complex" / "scope-c" / "40" / "git" / "default"


class TestUsngAlgbHistoryComplexScopeC40Tdd(unittest.TestCase):
    ...
    def test_large_file_set_scale_contract_holds_for_scope_c_via_replay(self) -> None:
