...
FIXTURE_GIT_DIR = Path(__file__).resolve().parents[3] / "TestdataNG-AlgB" / "history-complex" / "scope-b" / "39" / "git" / "default"


class TestUsngAlgbHistoryComplexScopeB39Tdd(unittest.TestCase):
    ...
    def test_large_file_set_scale_contract_holds_for_scope_b_via_replay(self) -> None:
