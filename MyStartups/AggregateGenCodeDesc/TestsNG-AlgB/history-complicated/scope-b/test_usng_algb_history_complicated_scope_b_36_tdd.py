...
FIXTURE_GIT_DIR = Path(__file__).resolve().parents[3] / "TestdataNG-AlgB" / "history-complicated" / "scope-b" / "36" / "git" / "default"


class TestUsngAlgbHistoryComplicatedScopeB36Tdd(unittest.TestCase):
    ...
    def test_attribution_contract_applies_to_scope_b_lines(self) -> None:
