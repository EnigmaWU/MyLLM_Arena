...
FIXTURE_GIT_DIR = Path(__file__).resolve().parents[3] / "TestdataNG-AlgB" / "history-complicated" / "scope-a" / "04" / "git" / "default"


class TestUsngAlgbHistoryComplicatedScopeA04Tdd(unittest.TestCase):
    ...
    def test_deleted_lines_excluded_from_result(self) -> None:
