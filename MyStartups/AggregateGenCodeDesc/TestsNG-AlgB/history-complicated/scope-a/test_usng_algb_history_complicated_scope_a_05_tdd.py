...
FIXTURE_GIT_DIR = Path(__file__).resolve().parents[3] / "TestdataNG-AlgB" / "history-complicated" / "scope-a" / "05" / "git" / "default"


class TestUsngAlgbHistoryComplicatedScopeA05Tdd(unittest.TestCase):
    ...
    def test_rename_preserves_attribution_lineage(self) -> None:
