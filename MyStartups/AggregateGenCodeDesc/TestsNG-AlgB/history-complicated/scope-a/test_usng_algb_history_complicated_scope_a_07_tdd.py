...
FIXTURE_GIT_DIR = Path(__file__).resolve().parents[3] / "TestdataNG-AlgB" / "history-complicated" / "scope-a" / "07" / "git" / "default"


class TestUsngAlgbHistoryComplicatedScopeA07Tdd(unittest.TestCase):
    ...
    def test_merge_preserves_effective_attribution(self) -> None:
