...
FIXTURE_GIT_DIR = Path(__file__).resolve().parents[3] / "TestdataNG-AlgB" / "history-complicated" / "scope-a" / "06" / "git" / "default"


class TestUsngAlgbHistoryComplicatedScopeA06Tdd(unittest.TestCase):
    ...
    def test_mixed_replay_produces_correct_final_record(self) -> None:
