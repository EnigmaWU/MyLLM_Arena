...
FIXTURE_GIT_DIR = Path(__file__).resolve().parents[3] / "TestdataNG-AlgB" / "history-simple" / "scope-a" / "21" / "git" / "default"


class TestUsngAlgbHistorySimpleScopeA21Tdd(unittest.TestCase):
