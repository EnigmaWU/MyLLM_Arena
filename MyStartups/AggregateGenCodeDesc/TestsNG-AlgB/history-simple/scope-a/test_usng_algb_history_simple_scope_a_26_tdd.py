...
FIXTURE_SVN_DIR = Path(__file__).resolve().parents[3] / "TestdataNG-AlgB" / "history-simple" / "scope-a" / "26" / "svn" / "default"


class TestUsngAlgbHistorySimpleScopeA26Tdd(unittest.TestCase):
