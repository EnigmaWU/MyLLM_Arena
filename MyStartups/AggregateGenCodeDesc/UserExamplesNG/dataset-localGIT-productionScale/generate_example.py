...
def write_example_metadata(output_dir: Path, args: argparse.Namespace, stats: ExampleStats) -> None:
    ...
    manifest = {
        ...
        "genRatioLocation": "Inspect genCodeDescSet/*.json for line attribution; if a patch carries a genRatio tail comment, treat it as a human-readable hint only, not aggregate input.",
    }
